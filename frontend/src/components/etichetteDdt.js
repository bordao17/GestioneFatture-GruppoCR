...
export const STATI_DDT = {
  ...
  CHECK: {
    ...
    colore: 'warning',
    spiegazione: 'Manca qualche campo, la scansione è poco leggibile, il fornitore è marcato critico, oppure il foglio parla di un punto vendita diverso da quello dichiarato: va riguardato a mano.',
  },
  KO: {
    etichetta: 'Errore',
